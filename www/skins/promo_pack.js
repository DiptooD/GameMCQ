window.registerSkinPack({
    ...
    // 2. THE PROMO CODES (Leave empty {} in future season packs if no promo codes are needed)
    promoCodes: {
    ...
    initTextures: function(scene) {
        ...
        if (!scene.textures.exists("hud_glassmorphism_img")) {
            g.clear(); g.fillStyle(0x002244, 0.8); g.fillRoundedRect(10, 10, 80, 80, 10);
        ...
        if (!scene.textures.exists("hud_military_img")) {
            g.clear(); g.fillStyle(0x1a1c1a, 1); g.fillRect(10, 10, 80, 80);
            g.lineStyle(4, 0x00ff00, 1); g.strokeRect(10, 10, 80, 80); g.lineStyle(6, 0xff0000, 1);
        ...
        if (!scene.textures.exists("hud_retro_img")) {
            g.clear(); g.fillStyle(0x0000aa, 1); g.fillRect(10, 10, 80, 80);
        ...
        if (!scene.textures.exists("hud_jungle_img")) {
            g.clear(); g.fillStyle(0x0a220a, 1); g.fillRoundedRect(10, 10, 80, 80, 8);
        ...
        if (!scene.textures.exists("battery_neon_img")) {
            g.clear(); g.fillStyle(0x110022, 1); g.fillRoundedRect(10, 30, 80, 40, 5);
        ...
        if (!scene.textures.exists("battery_plasma_img")) {
            g.clear(); g.fillStyle(0x001122, 1); g.fillRoundedRect(10, 30, 80, 40, 5);
        ...
        if (!scene.textures.exists("battery_crystal_img")) {
            g.clear(); g.fillStyle(0x220033, 1); g.fillRoundedRect(10, 30, 80, 40, 5);
