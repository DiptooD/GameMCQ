class SpinWheelScene extends Phaser.Scene {
    ...
    create() {
        ...
        this.segments = [
            ...
            { id: 'rare', type: 'keys', amount: 5, color: 0xffaa00, icon: 'ui_key', prob: 0.10, label: "5 KEYS" },
            { id: 'fire', type: 'booster', key: 'fireShield', amount: 2, color: 0x6600ff, icon: 'icon_booster_fire', prob: 0.28, label: "2x SHIELD" },
            { id: 'speed', type: 'booster', key: 'speedBoost', amount: 2, color: 0x0088ff, icon: 'icon_booster_speed', prob: 0.28, label: "2x SPEED" },
            { id: 'battery', type: 'booster', key: 'batteryEff', amount: 2, color: 0x00cc44, icon: 'icon_booster_battery', prob: 0.29, label: "2x BATTERY" }
        ];
